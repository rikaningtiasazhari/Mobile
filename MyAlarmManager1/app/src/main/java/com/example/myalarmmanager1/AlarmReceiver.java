...
import com.example.myalarmmanager1.R;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void setOneTimeAlarm(Context context, String type, String date, String time, String message){
        ...
        calendar.set(YEAR, Integer.parseInt(dateArray[0]));
        calendar.set(MONTH, Integer.parseInt(dateArray[1])-1);
        calendar.set(DAY_OF_MONTH, Integer.parseInt(dateArray[2]));
